        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form class="requires-validation f3 lh-copy" novalidate action="../../controllers/acc_loc_controller.php" method="post" name="myForm">
                      
                    <input class="form-control" type="hidden" name="id" value="<?php echo $id ?>">
                        <div class="col-md-12 pa2">
                            <label for="loc_name">Location Name</label>
                                <input class="form-control" type="text" name="loc" value="<?php echo $loc ?>" placeholder="Location" required onkeyup = "return validateText(document.myForm.loc.value,0)">
