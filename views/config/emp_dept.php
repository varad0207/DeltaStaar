        ...
        <div class="form-holder">
            <div class="form-content">
                <div class="form-items">
                    ...
                    <form class="requires-validation f3 lh-copy" novalidate action="../../controllers/emp_dept_controller.php" method="post" name="myForm" onsubmit="return validateEmpDept()">
